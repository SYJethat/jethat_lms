          ...
          {courseStepTab === 'videos' && (
            <div className="p-6 sm:p-8 rounded-3xl bg-white border border-slate-200 space-y-6 shadow-xs">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                {/* LEFT SIDE: Video Player & Video Cards */}
                        ...
                        <>
                          ...
                          <div className={`p-4 rounded-2xl border space-y-3 transition ${isVideo1Done ? 'bg-emerald-50/60 border-emerald-200' : 'bg-slate-50 border-slate-200'}`}>
                            <div className="flex items-center justify-between text-xs font-bold">
                              <span className="text-indigo-600 font-black">Video 1 (Unlocked)</span>
                              {isVideo1Done && <span className="text-emerald-600 flex items-center gap-1"><CheckCircle2 className="w-3.5 h-3.5" /> Completed</span>}
                            </div>
                            <h4 className="text-xs font-bold text-slate-900">{targetIndianLang.nameEng} Alphabets & Phonetics</h4>
                            <button
                              onClick={() => updateCourseProgress(activePlayCourse.id, { video1Done: true })}
                              className={`w-full py-2 rounded-xl text-xs font-bold transition ${isVideo1Done ? 'bg-emerald-600 text-white' : 'bg-indigo-600 hover:bg-indigo-700 text-white'}`}
                            >
                          ...
                          <div className={`p-4 rounded-2xl border space-y-3 transition ${
                            ...
                            <div className="flex items-center justify-between text-xs font-bold">
                              <span className={isVideo1Done ? 'text-indigo-600 font-black' : 'text-slate-400 font-bold'}>
                            ...
                            <h4 className="text-xs font-bold text-slate-900">{targetIndianLang.nameEng} Grammar & Sentence Order</h4>
                            <button
                          ...
                          <div className={`p-4 rounded-2xl border space-y-3 transition ${
                            ...
                            <div className="flex items-center justify-between text-xs font-bold">
                              <span className={isVideo2Done ? 'text-indigo-600 font-black' : 'text-slate-400 font-bold'}>
                            ...
                            <h4 className="text-xs font-bold text-slate-900">Spoken {targetIndianLang.nameEng} Fluency</h4>
                            <button
                  ...
                  {(() => {
                    ...
                    return (
                      <div className="pt-4 border-t border-slate-100 flex flex-col sm:flex-row items-center justify-between gap-3">
                        ...
                        >
                          {!allVideosDone ? '🔒 Finish All 3 Videos First' : 'Proceed to Step 2: Reading & Grammar →'}
                        </button>
                      </div>
                    );
                  })()}
                ...
                <div className="lg:col-span-5 xl:col-span-4 space-y-4">
                  <div className="p-5 rounded-3xl bg-slate-50 border border-slate-200 space-y-4 shadow-2xs">
                    <div className="space-y-1 border-b border-slate-200 pb-3">
                      ...
                      <span className="px-2.5 py-0.5 rounded-full bg-indigo-100 text-indigo-800 text-[11px] font-black inline-block mt-1">
                    ...
                    <div className="space-y-2.5 text-xs">
                      {[
                        ...
                        >
                            ...
                            <div>
                              <div className="flex items-center gap-2">
                                ...
                                <span className={`text-[9px] font-black uppercase px-1.5 py-0.2 rounded ${
                                  activeDayLesson === item.day ? 'bg-indigo-500 text-white' : 'bg-indigo-50 text-indigo-700'
                                }`}>
                                  {item.level}
                                </span>
                              </div>
                          ...
                          <span className={`text-xs font-mono font-extrabold shrink-0 ${activeDayLesson === item.day ? 'text-indigo-100' : 'text-slate-500'}`}>
                            {item.time}
                          </span>
                        </div>
                      ))}
